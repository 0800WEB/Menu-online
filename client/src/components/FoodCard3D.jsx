...
const FoodCard3D = ({ id, foodTitle, img, description, price, reviewScore, promoted }) => {
    ...
    return (
        <div className={`${containerClasses} flex flex-col sm:gap-2 rounded-custom-1 w-full h-max shadow-md overflow-hidden pb-1 sm:pb-2 bg-white bg-opacity-40`} onClick={() => setOpenDetails(true)}>
